...
GAS_index={'Methane': 0,
 ...
 'CarbonDioxide': 2,
 'Hydrogen': 3}
for TGT_gas in GAS_index.keys():
    print(TGT_gas)
    set_train,set_val,set_test=filter_by_gas(all_adinfo_list_select[0], TGT_gas),filter_by_gas(all_adinfo_list_select[1], TGT_gas),filter_by_gas(all_adinfo_list_select[2], TGT_gas)
    ...
    torch.save(best_model.state_dict(),'hmof-130T'+TGT_gas+'.pt')
