...
def parse_args():
    ...
    parser.add_argument('--head', type=int, default=8, help='Number of heads in FeedForward.')
    parser.add_argument('--ffn_dim', type=int, default=2048, help='Number of heads in multi-head attention.')
